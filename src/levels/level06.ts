...
export const level06: LevelDef = {
  id: 6,
  name: "Asteroid Belt",
  description: "Navigate the debris to reach the snipers",
  ...
  waves: [
    {
      enemies: [
        ...
        { type: "basic", rx: 0.6, ry: 0.5 },
        { type: "tracker", rx: 0.7, ry: 0.4 },
      ],
      asteroids: [
        ...
        { rx: 0.6, ry: 0.85, size: "medium" },
      ],
      walls: [
        { rx: 0.0, ry: 0.35, rw: 0.22, rh: 0.02, type: "solid" },
        { rx: 0.0, ry: 0.63, rw: 0.22, rh: 0.02, type: "solid" },
      ],
    },
  ],
};
